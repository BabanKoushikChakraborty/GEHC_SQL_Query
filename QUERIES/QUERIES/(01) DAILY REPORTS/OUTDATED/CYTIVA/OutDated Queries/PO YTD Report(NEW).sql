...
,decode(pvsa.pay_on_code,
  ...
  , pv.segment1 GSL,
(select location_code from hr_locations_all where location_id = PVSA.ship_to_location_id) ship_to_location,
