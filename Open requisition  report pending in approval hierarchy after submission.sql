...
--,prla.quantity * nvl(PRLA.currency_unit_price,PRLA.unit_price) "Line Amount"
...
,(case
when poa.action_code is null then
    upper('Pending for Approval')
else
    upper('BB')
end) "Action"
,poa.note
...
,to_date(SYSDATE,'DD-MM-YYYY')-to_date(prha.creation_date,'DD-MM-YYYY') as Aging        
